        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Fermerlere meslehete düzəlİş et</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('backend.advices.update', ['advice' => $advice->id])}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('patch')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="title" value="{{ $advice->title }}" id="example-text-input"  placeholder="Enter the name">
                                    </div>
                                ...
                                <div class="form-group img-section">
                                    ...
                                    <input id="uploadImage" value="{{$advice->image}}" type="file" name="image" class="form-control-file w-25" id="exampleFormControlFile1" onchange="PreviewImage();">
                                    ...
                                    if (empty($advice->image))
                                        ...
                                        echo "<img id='previewImage' src='".asset('uploads/advices/'.$advice->image)."' class='img-thumbnail preview-img w-25 mb-2' alt=''>";
                                    ?>
                                      <small class="text-danger">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" class="form-control" name="file" value="{{ $advice->file }}" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                                    </div>
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea cols="40" rows="10" class="form-control editor" id="editor" name="content" style="visibility:hidden; display: none;">{{ $advice->content }}</textarea>
                                    </div>
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-select" name="status" id="inlineFormSelectPref">
                                            <option value="1" <?php if ($advice->status ==1) echo 'selected' ?>>Aktiv</option>
                                            <option value="0" <?php if ($advice->status ==0) echo 'selected' ?>>Deaktiv</option>
                                        </select>
                                    </div>
                                    <small class="text-danger">
