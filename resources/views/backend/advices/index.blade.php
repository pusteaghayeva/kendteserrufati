                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Fermerlere meslehet</h4>
                                        <div class="button-items">
                                            <a href="{{route('backend.advices.create')}}" class="btn btn-primary waves-effect waves-ligh mt-2">  <i class="mdi mdi-plus me-1"></i>Yarat</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                     ...
                                     <tr id="row{{ $advice->id }}">
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <img src="{{ asset('uploads/advices/'. $image) }}" width="100">
                                            </td>
                                            <td>{{ $advice->title }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('backend.advices.edit', ['advice' => $advice->id]) }}"
                                                    class=" text-success"><i
                                                        class="mdi mdi-pencil font-size-24"></i></a>
                                                <a class="text-danger deleteBtn" data-id="{{ $advice->id }}"><i
...
@section('js')
    <script>
        ...
        $('.deleteBtn').click(function () {
                ...
                let route = '{{route('backend.advices.destroy', ['advice'=>'id'])}}';
