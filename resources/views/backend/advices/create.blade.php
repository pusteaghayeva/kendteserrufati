        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Qanunlar</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('backend.advices.store')}}" enctype="multipart/form-data" method="POST">
                                @csrf
...
@section('styles')
    <link rel="stylesheet" href="/backend/assets/libs/summernote/summernote.min.css">
@endsection
