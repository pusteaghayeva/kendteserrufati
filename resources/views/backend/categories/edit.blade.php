                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name="title" value="{{$category->title}}" id="example-text-input"  placeholder="Enter the name">
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-select" name="status" id="inlineFormSelectPref">
                                        <option value="1" <?php if ($category->status ==1) echo 'selected' ?>>Aktiv</option>
                                        <option value="0" <?php if ($category->status ==0) echo 'selected' ?>>Deaktiv</option>
                                    </select>
                                </div>
                                <small class="text-danger">
