                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="button-items">
                                            <a href="{{route('backend.categories.create')}}" class="btn btn-primary waves-effect waves-ligh mt-2"><i class="mdi mdi-plus me-1"></i>Yarat</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($categories as $category)
                                            ...
                                            <td>
                                                ...
                                                <a class="text-danger deleteBtn" data-id="{{ $category->id }}"><i
...
@section('js')
    <script>
        ...
        $('.deleteBtn').click(function () {
                ...
                let route = '{{route('backend.categories.destroy', ['category'=>'id'])}}';
