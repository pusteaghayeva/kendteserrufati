        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Yenİ aqrar xəbər daxİl edİn</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('backend.aqrarnews.store')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                            ...
                            <div class="form-group img-section">
                                ...
                                <input id="uploadImage-create" type="file" name="image" class="form-control-file w-25" onchange="PreviewImageCreate();">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    <label for="example-email-input" class="col-md-2 col-form-label">Fayl</label>
                                    <div class="col-md-10">
