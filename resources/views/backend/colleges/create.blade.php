        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Yenİ kolleqa daxİl edİn</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('backend.colleges.store')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="surname" value="" id="example-text-input"  placeholder="Soyad daxil edin">
                                    </div>
                                    <small class="text-danger">
